...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1>Área do autor - Formulário de Edição</h1>
            <form action="/admin/autor/${autorId}/edit" method="post">
            ...
            <form action="/admin/autor/${autorId}/remove" method="post" id="removeForm">
                <input type="submit" class="btn btn-danger" value="Remover">
            </form>

            <script type="text/javascript">
                function askForSubmit(event) {
                    if (confirm("Tem certeza disso?") != true) {
                        event.preventDefault();
                    }
                }
                document
                    .getElementById("removeForm")
                    .addEventListener('submit', askForSubmit);
            </script>
        </div>
    </body>
</html>